...
Look at examples [here](https://github.com/lets-fiware/FIWARE-Small-Bang/tree/main/examples/iotagent-ul-mqtt).
...
```bash
 curl -X POST "https://iotagent-http.local/iot/ul?k=Dk8A0vfwTkTiAY71QyyKzOv9CT&i=sensor003" \
...
Look at examples [here](https://github.com/lets-fiware/FIWARE-Small-Bang/tree/main/examples/iotagent-ul-http).
