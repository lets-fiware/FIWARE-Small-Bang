...
[こちら](https://github.com/lets-fiware/FIWARE-Small-Bang/tree/main/examples/iotagent-json-mqtt)の例を参照ください。
...
[こちら](https://github.com/lets-fiware/FIWARE-Small-Bang/tree/main/examples/iotagent-json-http)の例を参照ください。
