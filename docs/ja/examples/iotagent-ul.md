...
[こちら](https://github.com/lets-fiware/FIWARE-Small-Bang/tree/main/examples/iotagent-ul-mqtt) の例を参照ください。
...
[こちら](https://github.com/lets-fiware/FIWARE-Small-Bang/tree/main/examples/iotagent-ul-http)の例を参照ください。
